...
namespace Application.Jingdong.Extension.JingDongAlliance.Dto
{
    ...
    /// 订单行查询接口返回结果
    /// </summary>
    public class JDUnionOpenJDUnionOpenOrderRowQueryResponseDto
    {
        /// <summary>
        /// 响应信息
        /// </summary>
        [JsonProperty("jd_union_open_order_row_query_responce")]
        public OrderRowQueryResponseDto Response { get; set; } = new OrderRowQueryResponseDto();
    }

    /// <summary>
    /// 响应信息
    /// </summary>
    public class OrderRowQueryResponseDto
    {
        /// <summary>
        /// 返回码
        /// </summary>
    ...
    /// 查询结果
    /// </summary>
    public class OrderRowQueryqueryResultResponseDto
    {
        /// <summary>
        /// 返回码
        /// </summary>
        ...
        /// </summary>
        [JsonProperty("data")]
        public List<OrderRowQueryDataResponseDto> Data { get; set; } = new List<OrderRowQueryDataResponseDto>();
    ...
    /// 数据明细
    /// </summary>
    public class OrderRowQueryDataResponseDto
    {
        /// <summary>
        ...
        /// <summary>
        /// 父单的订单号：如一个订单拆成多个子订单时，原订单号会作为父单号，拆分的订单号为子单号存储在orderid中
        /// 若未发生拆单，该字段为0
        /// </summary>
        ...
        /// <summary>
        /// 预估计佣金额：由订单的实付金额拆分至每个商品的预估计佣金额，不包括运费，以及京券、东券、E卡、余额等虚拟资产支付的金额。
        /// 该字段仅为预估值，实际佣金以actualCosPrice为准进行计算
        /// </summary>
        ...
        /// 第19位是0或1时，均代表普通订单
        /// 第20位：预售订单 
        /// 例如：00000000000000000000000000000001:红包订单
        ...
        /// 默认：0。表示最新的预估结算日期
        /// 当payMonth为当前的未来时间时，表示该订单可结算；当payMonth为当前的过去时间时，表示该订单已结算
        /// </summary>
        ...
        public OrderRowQueryDataGoodsInfoResponseDto GoodsInfo { get; set; } = new OrderRowQueryDataGoodsInfoResponseDto();

        /// <summary>
        /// 类目信息,入参传入fields，categoryInfo获取
        /// </summary>
        [JsonProperty("categoryInfo")]
        public OrderRowQueryDataCategoryInfoResponseDto CategoryInfo { get; set; } = new OrderRowQueryDataCategoryInfoResponseDto();
    ...
    /// 商品信息
    /// </summary>
    public class OrderRowQueryDataGoodsInfoResponseDto
    {
        /// <summary>
        /// sku主图链接
        /// </summary>
    ...
    /// 类目信息
    /// </summary>
    public class OrderRowQueryDataCategoryInfoResponseDto
    {
        /// <summary>
        /// 一级类目id
        /// </summary>
