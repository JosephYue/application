...
namespace Application.ChannelMessage.Extension.ChannelMessage.Extension
{
    public class SnowflakeId
    {
        ...
        public static SnowflakeId Default()
        {
            lock (SLock)
            {
                ...
                return _snowflakeId = new SnowflakeId(random.Next((int)MaxWorkerId), random.Next((int)MaxDatacenterId));
            }
        }
